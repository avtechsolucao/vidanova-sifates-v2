...
procedure GradeProduto_Salvar(nIDX: Integer; nPedido: Integer; REFERENCIA, sAprovado: String; StringGrade: TStringGrid);
...
begin
   ...
   GradeZerar(StringGrade);

   StringGrade.ColCount := TabelaTamanhos.RecordCount + 1;
   if StringGrade.ColCount<=1 then
     StringGrade.ColCount :=2;

   StringGrade.RowCount := TabelaCores.RecordCount + 1;
   if StringGrade.RowCount<=1 then
     StringGrade.RowCount :=2;
...
begin
   ...
   begin
      ...
      TabelaArmazenar.FieldByName('IDX').AsInteger           := nIDX;
      ...
      TabelaArmazenar.FieldByName('IDENTIFICADOR').AsString := GetIdentificador(REFERENCIA,
      ...
      begin
         ...
         begin
            ...
            TabelaArmazenar.FieldByName('QUANTIDADE').AsInteger :=  StrToIntDef(StringGrade.Cells[Coluna, Linha],0);
...
begin
   ...
   begin
      ...
      TabelaArmazenar.FieldByName('IDENTIFICADOR').AsString := GetIdentificador(stReferencia,
                                                                            TabelaArmazenar.FieldByName('COR_ID').AsInteger,
                                                                            TabelaArmazenar.FieldByName('TAMANHO_ID').AsInteger
                                                                            );
