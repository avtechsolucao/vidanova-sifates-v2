...
begin
   ...
   If BaseDados.db_Parametros.FieldByName('CODIFICACAO')
     .AsString = 'AUTO' Then
   begin
...
begin
   ...
   begin
      ...
      Wtexto[3] := ZeroEsquerda(db_referencias.FieldByName('CODIGO').AsString,
        BaseDados.db_Parametros.FieldByName('PRODUTO').AsInteger);
...
begin
   ...
   dbProcurarFichaTecnica.SearchQuery.Add(' SELECT E.*,P.TIPO_PRODUTO FROM VIEW_REFERENCIAS E, CAD_PRODUTOS P');
   ...
   dbProcurarFichaTecnica.SearchQuery.Add(' e.referencia=p.referencia');
   dbProcurarFichaTecnica.SearchQuery.Add(' AND');
   dbProcurarFichaTecnica.SearchQuery.Add(' %WHERE%');
...
begin
   ...
   If BaseDados.db_Parametros.FieldByName('CODIFICACAO').AsString = 'AUTO' Then
   begin
