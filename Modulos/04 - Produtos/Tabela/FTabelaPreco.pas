...
begin
   ...
   FUsuario.LogUsuario('Tabela de Preços','Clicou no botão Alterar. Na Tabela de preço ['+IntToStr(nTabelaPreco)+']');
...
begin
   ...
   FUsuario.LogUsuario('Tabela de Preços','Deletou tabela de preço ['+IntToStr(nTabelaPreco)+']');
...
begin
   ...
   FUsuario.LogUsuario('Tabela de Preços','Imprimiu a tabela ['+IntToStr(nTabelaPreco)+']' );
   db_TabelaDetalhes.Close;
...
begin
   ...
   begin
      ...
      FUsuario.LogUsuario('Tabela de Preços','Procurou e colocalizou a tabela ['+IntToStr(nTabelaPreco)+']' );
...
begin
   ...
   FUsuario.LogUsuario('Tabela de Preços','Clicou no botão Salvar. Na Tabela de preço ['+IntToStr(nTabelaPreco)+']');
...
begin
   ...
   begin
     ...
     begin
      FUsuario.LogUsuario('Tabela de Preços','Na Tabela de preço ['+IntToStr(nTabelaPreco)+
...
begin
   ...
   nTabelaPreco := db_TabelaPreco.FieldByName('CODIGO').AsInteger;
   if bImportando=false then
      FUsuario.LogUsuario('Tabela de Preços','Na Tabela de preço ['+IntToStr(nTabelaPreco)+'], alterou o preço da referencia: ['+db_TabelaReferencia.FieldByName('REFERENCIA').AsString+']' );
end;
...
begin
   nTabelaPreco := db_TabelaPreco.FieldByName('CODIGO').AsInteger;
   FUsuario.LogUsuario('Tabela de Preços','Na Tabela de preço ['+IntToStr(nTabelaPreco)+'], deletou a referencia: ['+db_TabelaReferencia.FieldByName('REFERENCIA').AsString+']' );
...
begin
   nTabelaPreco := db_TabelaPreco.FieldByName('CODIGO').AsInteger;
   FUsuario.LogUsuario('Tabela de Preços','Na Tabela de preço ['+IntToStr(nTabelaPreco)+'], alterou o nome da tabela.' );
