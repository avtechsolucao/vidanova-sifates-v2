...
uses
   ...
   ACBrDevice, ACBrETQ, ACBrBase, Grids, DBGrids, FFrameBarra,
...
uses FPrincipal, Biblioteca, Global,
  FEtiquetaProdutosConfigurar, SQLServer, Biblioteca_pcp, FEtiquetaCriarGrade;
    ...
    begin
      ...
      begin
         ...
         BEGIN
            ...
            db_lista.FieldByName('PRECO').AsFloat            :=  StrToFloatDef(GetProdutoCampo(UPPERCASE(DB_Produtos.FieldByName('REFERENCIA').AsString),'PRC_VENDA'),0);
...
begin
   ...
   begin
      ...
      CadProduto_EstoqueSalvar(StrToIntDef(GetProdutoCampo(strProduto,'CODIGO'),0),
                                 strProduto,
                                 StringGridOpcoes);
...
begin
   ...
   begin
      FrmtiquetaCriarGrade:=TFrmtiquetaCriarGrade.create(self);
      FrmtiquetaCriarGrade.Showmodal;
   end;
