object FrmEtiquetasGerar: TFrmEtiquetasGerar
  Left = 1
  Top = 1
  ...
  object PainelPrincipal: TPanel
    ...
    object BoxConfiguracoes: TGroupBox
      Left = 1
      Top = 57
      Width = 650
      Height = 491
      ...
      object gbxProdutos: TGroupBox
        ...
        object NumQtdeEtiquetas: TSpinEdit
          ...
          TabOrder = 3
          Value = 1
          OnChange = NumQtdeEtiquetasChange
        end
      ...
      object gbxPedidoVenda: TGroupBox
        Left = 2
        Top = 435
        Width = 646
        Height = 65
        ...
        TabOrder = 4
        Visible = False
        object editPedidoVenda: TIDBEditDialog
          Left = 200
          Top = 38
          Width = 112
          Height = 27
    ...
    object Panel1: TPanel
      ...
      object Label2: TLabel
        ...
        FocusControl = editQtdeDescricao
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Calibri'
      ...
      object editQtdeDescricao: TSpinEdit
        Left = 520
        Top = 13
        Width = 65
        Height = 22
        Hint = 
          'Ajustar a quantidade de caracteres (incluindo os espa'#231'o) que sai' +
          'r'#225' na descri'#231#227'o do produto'
        MaxValue = 0
        MinValue = 0
        TabOrder = 1
        Value = 30
      ...
      object chkCodigoCompleto: TCheckBox
        Left = 453
        Top = 35
        Width = 148
        Height = 17
        Caption = 'Imprimir c'#243'digo completo'
        Checked = True
        State = cbChecked
        TabOrder = 2
      end
  ...
  object PopupMenu1: TPopupMenu
    ...
    object DesignReportPreview1: TMenuItem
      Caption = 'Design Report - Preview'
      Visible = False
    end
  end
  ...
  object db_lista: TFDQuery
    ...
    object db_listaPRECO: TFloatField
      FieldName = 'PRECO'
    end
