...
uses
   ...
   frxClass, frxDBSet, frxBarcod, FireDAC.Stan.Intf, FireDAC.Stan.Option,
  FireDAC.Stan.Param, FireDAC.Stan.Error, FireDAC.DatS, FireDAC.Phys.Intf,
  FireDAC.DApt.Intf, FireDAC.Stan.Async, FireDAC.DApt, FireDAC.Comp.DataSet,
  FireDAC.Comp.Client, FrmRelatorios, ISFEdit, ISFEditbtn, ISFdbEditbtn,
  IDBEdit, uEstSearchDialogZeos, Vcl.Samples.Spin, Vcl.ComCtrls;
...
uses FEtiquetaConfigurar, Global, Biblioteca,
   FCompras, FastReport, FEtiquetaCriarGrade;
