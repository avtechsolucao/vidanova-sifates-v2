...
type
   ...
   TFrmCompras = class(TForm)
    ...
    SPDELETA_COMPRA_PRODUTOS: TFDStoredProc;
      ...
      db_ComprasItensICMS_BASECALCULO: TFloatField;
      db_ComprasItensICMS_REDUCAO: TFloatField;
      db_ComprasItensICMS_REDUCAO_VALOR: TFloatField;
      db_ComprasItensIPI_BASECALCULO: TFloatField;
      db_ComprasItensIPI_VALOR: TFloatField;
      db_ComprasItensVL_UNITARIO: TFloatField;
      db_ComprasItensDESCONTO: TFloatField;
      db_ComprasItensDESCONTO_VLR: TFloatField;
      db_ComprasItensMARKUP: TFloatField;
      db_ComprasItensMG_LUCRO: TFloatField;
      db_ComprasItensPRC_VENDA: TFloatField;
      db_ComprasItensVL_TOTAL: TFloatField;
      ...
      db_ComprasICMS_BASECALCULO: TFloatField;
      db_ComprasICMS_BASECALCULO_SUBSTITUICAO: TFloatField;
      db_ComprasICMS_VALOR_SUBSTITUICAO: TFloatField;
      db_ComprasICMS_REDUCAO: TFloatField;
      db_ComprasICMS_REDUCAO_VALOR: TFloatField;
      db_ComprasIPI_BASECALCULO: TFloatField;
      db_ComprasIPI_VALOR: TFloatField;
      db_ComprasISS: TFloatField;
      db_ComprasISS_BASECALCULO: TFloatField;
      db_ComprasISS_VALOR: TFloatField;
      db_ComprasVLR_SEGURO: TFloatField;
      db_ComprasVLR_DESPESAS_ASSESSORIAS: TFloatField;
      db_ComprasDESCONTO: TFloatField;
      db_ComprasVLR_DESCONTO: TFloatField;
      db_ComprasVLR_RECEBIDO: TFloatField;
      db_ComprasTROCO: TFloatField;
      db_ComprasVLR_CAIXA: TFloatField;
      ...
      db_ComprasFRETE_PBRUTO: TFloatField;
      db_ComprasFRETE_PLIQUIDO: TFloatField;
      db_ComprasQTDE_PRODUTOS: TIntegerField;
      db_ComprasVALOR_PRODUTOS: TFloatField;
      db_ComprasTOTAL_NF: TFloatField;
      ...
      db_ComprasItensQUANTIDADE: TFloatField;
      db_ComprasPFRETE: TFloatField;
      db_ComprasPFRETE_VALOR: TFloatField;
      db_ComprasItensICMS: TFloatField;
      db_ComprasItensICMS_VALOR: TFloatField;
      db_ComprasItensIPI: TFloatField;
      db_ComprasItensPFRETE: TFloatField;
      db_ComprasItensPFRETE_VALOR: TFloatField;
    db_ComprasICMS_VALOR: TFloatField;
    ...
    DBEdit2: TDBEdit;
    Label1: TLabel;
    db_ComprasFRETE_VALOR: TFloatField;
...
procedure TFrmCompras.db_CtaPagarAfterPost(DataSet: TDataSet);
begin
  db_CtaPagar.Close;
  db_CtaPagar.Open;
end;
...
procedure TFrmCompras.db_CtaPagarFreteAfterPost(DataSet: TDataSet);
begin
  db_CtaPagarFrete.Close;
  db_CtaPagarFrete.Open;
end;
...
procedure TFrmCompras.db_ComprasAfterScroll(DataSet: TDataSet);
begin
  ConfiguraBotaoEstornar;
end;
