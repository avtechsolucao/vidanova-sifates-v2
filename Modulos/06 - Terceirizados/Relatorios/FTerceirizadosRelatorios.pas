...
procedure TFrmTerceirizadosRelatorios.FormShow(Sender: TObject);
begin
   TRadioGroup(RadioTipo_Relatorio.Controls[1]).Visible:= False;
   TRadioGroup(RadioTipo_Relatorio.Controls[2]).Visible:= False;
   TRadioGroup(RadioTipo_Relatorio.Controls[3]).Visible:= False;
end;
