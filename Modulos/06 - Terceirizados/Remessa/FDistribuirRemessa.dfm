object FrmDistribuirRemessa: TFrmDistribuirRemessa
  ...
  object db_DistribuirTerceirizados: TFDQuery
    ...
    object db_DistribuirTerceirizadosQTDE_RETORNADA: TIntegerField
      FieldName = 'QTDE_RETORNADA'
      Origin = 'QTDE_RETORNADA'
      DisplayFormat = '###,##0'
    end
    object db_DistribuirTerceirizadosQTDE_RESTANTE: TLargeintField
      FieldName = 'QTDE_RESTANTE'
    ...
    object db_DistribuirTerceirizadosVLR_UNITARIO: TFloatField
      FieldName = 'VLR_UNITARIO'
      Origin = 'VLR_UNITARIO'
      DisplayFormat = '###,##0.00'
    end
    object db_DistribuirTerceirizadosVLR_TOTAL: TFloatField
      FieldName = 'VLR_TOTAL'
      Origin = 'VLR_TOTAL'
      DisplayFormat = '###,##0.00'
    end
  ...
  object FrxDistribuir: TfrxReport
    ...
    ReportOptions.CreateDate = 43122.941049838000000000
    ReportOptions.LastChange = 43122.941049838000000000
  ...
  object db_DistribuirReferencias: TFDQuery
    ...
    object db_DistribuirReferenciasQUANTIDADE: TLargeintField
      FieldName = 'QUANTIDADE'
      Origin = 'QUANTIDADE'
      DisplayFormat = '###,##0'
    end
    object db_DistribuirReferenciasVALOR_UNIT: TFloatField
      FieldName = 'VALOR_UNIT'
      Origin = 'VALOR_UNIT'
      DisplayFormat = '###,##0.00'
    end
    object db_DistribuirReferenciasVLR_TOTAL: TFloatField
      FieldName = 'VLR_TOTAL'
      Origin = 'VLR_TOTAL'
      DisplayFormat = '###,##0.00'
    end
