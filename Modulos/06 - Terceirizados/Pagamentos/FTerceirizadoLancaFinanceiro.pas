...
procedure TFrmTerceirizadoLancaFinanceiro.btnPagarClick(Sender: TObject);
begin
...
procedure TFrmTerceirizadoLancaFinanceiro.db_CtaPagarAfterPost(
  DataSet: TDataSet);
begin
  db_CtaPagar.Close;
  db_CtaPagar.Open;
...
begin
   ...
   db_CtaPagar.FieldByName('EMPRESA').AsInteger   := FSistema.Empresa ;
   db_CtaPagar.FieldByName('NOTAFISCAL').AsInteger :=  db_Terceirizados.FieldByName('CODIGO').AsInteger;
   db_CtaPagar.FieldByName('FORNECEDOR').AsInteger :=  db_Terceirizados.FieldByName('TERCEIRIZADO').AsInteger;
   db_CtaPagar.FieldByName('DATA').AsDateTime :=  db_Terceirizados.FieldByName('DATARETORNO').AsDateTime;
   ...
   db_CtaPagar.FieldByName('HISTORICO').AsString := 'TERCEIRIZADO/PAGAMENTO | CODIGO: ' +
     db_Terceirizados.FieldByName('CODIGO').AsString + ' | LANÇADO POR: '+UpperCase (FUsuario.Nome);
...
begin
   btnPagar.Caption :='Gerar '+sLineBreak+'[Contas a Pagar]';
