object FrmArquivoMorto: TFrmArquivoMorto
  Left = 0
  Top = 0
    ...
    object AdvGroupBox2: TGroupBox
      ...
      object cxGrid2: TcxGrid
        ...
        object cxGridPedidosItens: TcxGridDBTableView
          ...
          object cxGridPedidosItensColumn6: TcxGridDBColumn
            Caption = 'ITEM 2'
            MinWidth = 80
            Width = 150
          end
          object cxGridPedidosItensColumn7: TcxGridDBColumn
            Caption = 'ITEM 3'
            MinWidth = 80
            Width = 148
          end
  ...
  inline FrmFrameBarra1: TFrmFrameBarra
    ...
    inherited pnTitulo: TPanel
      ...
      inherited LblBarraTitulo: TLabel
        Width = 885
        Height = 28
        Caption = 'CONSULTA ARQUIVO MOROO'
        ExplicitWidth = 320
        ExplicitHeight = 28
      end
  ...
  object GroupBox1: TGroupBox
    ...
    object ed_pedido: TIDBEditDialog
      Left = 16
      Top = 33
      Width = 105
      Height = 23
      ...
      SQLdbMaxLenght = 10
      SearchQuery.Strings = (
        'SELECT * FROM VIEW_SIFATES_PEDIDOS'
        '%WHERE%')
      SearchDialogFieldList = <
        item
          FieldName = 'CLIENTE'
  ...
  object db_PedidoItens: TFDQuery
    ...
    SQL.Strings = (
      'SELECT * FROM VIEW_SIFATES_PEDIDOS_ITENS'
      'WHERE'
      'CODIGO=:CODIGO')
    Left = 160
    Top = 96
