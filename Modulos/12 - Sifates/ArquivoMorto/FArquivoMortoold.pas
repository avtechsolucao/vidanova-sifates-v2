...
procedure TFrmArquivoMorto.FormCreate(Sender: TObject);
begin
...
procedure TFrmArquivoMorto.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
   { if Key = VK_F2 then
    begin
...
procedure TFrmArquivoMorto.FormResize(Sender: TObject);
begin
...
procedure TFrmArquivoMorto.CalculaPedido;
begin
...
Function TFrmArquivoMorto.ChecarProtecaoPedido : Boolean;
begin
  Result :=((db_Pedido.FieldByName('APROVADO').AsString = 'S')  or (db_Pedido.FieldByName('APROVADO').AsString = 'SIM' ));
end;

procedure TFrmArquivoMorto.dbGrid_ProdutosColEnter(Sender: TObject);
begin
...
procedure TFrmArquivoMorto.dbGrid_ProdutosColExit(Sender: TObject);
begin
  if (dbGrid_Produtos.SelectedField = db_PedidoItensQTDE) and
...
procedure TFrmArquivoMorto.prcProcurarProduto;
begin
...
procedure TFrmArquivoMorto.prcSetarDadosCliente;
begin
...
procedure TFrmArquivoMorto.dbGrid_ProdutosEditButtonClick(Sender: TObject);
begin
...
procedure TFrmArquivoMorto.dbGrid_ProdutosEnter(Sender: TObject);
begin
   FrmFrameBotoes1.SpbSalvarClick(Sender);
end;

procedure TFrmArquivoMorto.dbGrid_ProdutosExit(Sender: TObject);
begin
   CalculaPedido;
end;

procedure TFrmArquivoMorto.dbGrid_ProdutosKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  ...
  nTabelaPreco := db_Pedido.FieldByName('TABELA').AsInteger;
   ...
   begin
      ...
      //FrmPedidoVendaCodigoBarra := TFrmArquivoMortoCodigoBarra.Create(self);
...
procedure TFrmArquivoMorto.dbGrid_ProdutosKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TFrmArquivoMorto.db_PedidoAfterDelete(DataSet: TDataSet);
begin
...
procedure TFrmArquivoMorto.db_PedidoAfterPost(DataSet: TDataSet);
Var
  mID : Integer;
begin
...
procedure TFrmArquivoMorto.db_PedidoAfterScroll(DataSet: TDataSet);
begin
   //ChecarProtecaoPedido;
   if ChecarProtecaoPedido then
   begin
...
procedure TFrmArquivoMorto.db_PedidoBeforePost(DataSet: TDataSet);
begin
...
procedure TFrmArquivoMorto.db_PedidoCLIENTEChange(Sender: TField);
var
  mIDFPagto : Integer;
begin
   mIDFPagto := 0;
...
procedure TFrmArquivoMorto.db_PedidoDATAChange(Sender: TField);
begin
...
procedure TFrmArquivoMorto.db_PedidoItensAfterDelete(DataSet: TDataSet);
begin
   CalculaPedido;
end;

procedure TFrmArquivoMorto.db_PedidoItensAfterOpen(DataSet: TDataSet);
begin
  DimensionarGrid(DBGrid_Produtos,self);

end;

procedure TFrmArquivoMorto.db_PedidoItensAfterPost(DataSet: TDataSet);
begin
//   db_PedidoItens.Close;
//   db_PedidoItens.Open;
   CalculaPedido;
...
procedure TFrmArquivoMorto.db_PedidoItensBeforeInsert(DataSet: TDataSet);
begin
...
procedure TFrmArquivoMorto.db_PedidoItensBeforePost(DataSet: TDataSet);
begin
...
procedure TFrmArquivoMorto.db_PedidoItensREFERENCIAChange(Sender: TField);
begin
...
begin
   ...
   //FrmPedidoVendaParcial:=TFrmArquivoMortoParcial.Create(Self);
   //FrmPedidoVendaParcial.ShowModal;

end;

procedure TFrmArquivoMorto.BtnRecalcularClick(Sender: TObject);
begin
...
procedure TFrmArquivoMorto.db_PedidoNewRecord(DataSet: TDataSet);
begin
...
procedure TFrmArquivoMorto.ClienteKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = VK_F8 then
  begin
...
procedure TFrmArquivoMorto.EditClienteKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmArquivoMorto.EditNomeClienteChange(Sender: TObject);
begin
  prcSetarDadosCliente;
end;

procedure TFrmArquivoMorto.EditObservacaoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = VK_RETURN then
  begin
...
procedure TFrmArquivoMorto.FrmFrameBotoes1SpbAdicionarClick(Sender: TObject);
begin
   check_endereco := true;
...
procedure TFrmArquivoMorto.FrmFrameBotoes1SpbCancelarClick(Sender: TObject);
begin
   db_PedidoItens.Cancel;
   db_Pedido.Cancel;
...
procedure TFrmArquivoMorto.FrmFrameBotoes1SpbEditarClick(Sender: TObject);
begin
...
procedure TFrmArquivoMorto.FrmFrameBotoes1SpbExcluirClick(Sender: TObject);
begin
   if not FProgramador  then
   begin
     if (db_Pedido.FieldByName('PRODUZINDO').AsString = 'S') or
...
procedure TFrmArquivoMorto.FrmFrameBotoes1SpbImprimirClick(Sender: TObject);
var
  mGrade : Boolean;
begin
  mGrade := False;
...
procedure TFrmArquivoMorto.FrmFrameBotoes1SpbProcurarClick(Sender: TObject);
begin
...
procedure TFrmArquivoMorto.FrmFrameBotoes1SpbSairClick(Sender: TObject);
begin
...
procedure TFrmArquivoMorto.FrmFrameBotoes1SpbSalvarClick(Sender: TObject);
begin
  try
...
procedure TFrmArquivoMorto.ImprimirPedidocomvalores1Click(Sender: TObject);
begin
   FrmFrameBotoes1SpbImprimirClick(Sender);
end;


procedure TFrmArquivoMorto.AdvGroupBox4Exit(Sender: TObject);
begin
   if db_Pedido.FieldByName('CLIENTE').AsInteger <1 then
   begin
      aviso('Campo Cliente é obrigatório');
...
procedure TFrmArquivoMorto.prcAbriGrade;
var
 mIDX : Integer;
begin
  { if (FParametros.Quantificar='NORMAL') then
   ...
   try
     ...
     begin
        FrmPedidoVendaGrade := TFrmArquivoMortoGrade.Create(self);
...
procedure TFrmArquivoMorto.EditKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = VK_RETURN then
  begin
