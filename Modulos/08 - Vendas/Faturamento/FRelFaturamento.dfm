object FrmRelFaturamento: TFrmRelFaturamento
  ...
  object db_ComissaoPedidos: TFDQuery
    ...
    object db_ComissaoPedidosVENDEDORSALARIO: TFloatField
      FieldName = 'VENDEDORSALARIO'
      ReadOnly = True
    end
    object db_ComissaoPedidosCOMISSAOCADASTRO: TFloatField
      FieldName = 'COMISSAOCADASTRO'
      ReadOnly = True
      DisplayFormat = '###,##0.00%'
    end
    object db_ComissaoPedidosCOMISSAOPEDIDO: TFloatField
      FieldName = 'COMISSAOPEDIDO'
      ReadOnly = True
      DisplayFormat = '###,##0.00%'
    end
    object db_ComissaoPedidosCOMISSAO_VALORVIACADASTRO: TFloatField
      FieldName = 'COMISSAO_VALORVIACADASTRO'
      ReadOnly = True
      DisplayFormat = '###,##0.00'
    end
    object db_ComissaoPedidosCOMISSAO_VALORVIAPEDIDO: TFloatField
      FieldName = 'COMISSAO_VALORVIAPEDIDO'
      ReadOnly = True
      DisplayFormat = '###,##0.00'
    end
    object db_ComissaoPedidosCOMISSAO_COM_SALARIO: TFloatField
      FieldName = 'COMISSAO_COM_SALARIO'
      ReadOnly = True
      DisplayFormat = '###,##0.00'
    end
    object db_ComissaoPedidosVALORTOTAL: TFloatField
