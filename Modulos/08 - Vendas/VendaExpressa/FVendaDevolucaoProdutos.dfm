object FrmVendaDevolucaoProdutos: TFrmVendaDevolucaoProdutos
  ...
  object db_VendasDevolucaoItens: TFDQuery
    ...
    object db_VendasDevolucaoItensQUANTIDADE: TFloatField
      FieldName = 'QUANTIDADE'
      OnChange = db_VendasDevolucaoItensQUANTIDADEChange
      DisplayFormat = '###,##0'
    end
    object db_VendasDevolucaoItensVLR_UNIT: TFloatField
      FieldName = 'VLR_UNIT'
      OnChange = db_VendasDevolucaoItensVLR_UNITChange
      DisplayFormat = '###,##0.00'
    end
    object db_VendasDevolucaoItensIPI: TFloatField
      FieldName = 'IPI'
      DisplayFormat = '###,##0.00'
    end
    object db_VendasDevolucaoItensVLR_IPI: TFloatField
      FieldName = 'VLR_IPI'
      DisplayFormat = '###,##0.00'
    end
    object db_VendasDevolucaoItensICMS: TFloatField
      FieldName = 'ICMS'
      DisplayFormat = '###,##0.00'
    end
    object db_VendasDevolucaoItensVLR_ICMS: TFloatField
      FieldName = 'VLR_ICMS'
      DisplayFormat = '###,##0.00'
    end
    object db_VendasDevolucaoItensISS: TFloatField
      FieldName = 'ISS'
      DisplayFormat = '###,##0.00'
    end
    object db_VendasDevolucaoItensISS_BASECALCULO: TFloatField
      FieldName = 'ISS_BASECALCULO'
      DisplayFormat = '###,##0.00'
    end
    object db_VendasDevolucaoItensISS_VALOR: TFloatField
      FieldName = 'ISS_VALOR'
      DisplayFormat = '###,##0.00'
    end
    object db_VendasDevolucaoItensDESCONTO: TFloatField
      FieldName = 'DESCONTO'
      DisplayFormat = '###,##0.00'
    end
    object db_VendasDevolucaoItensVLR_DESCONTO: TFloatField
      FieldName = 'VLR_DESCONTO'
      DisplayFormat = '###,##0.00'
    end
    object db_VendasDevolucaoItensVLR_TOTAL: TFloatField
      FieldName = 'VLR_TOTAL'
      DisplayFormat = '###,##0.00'
    end
  ...
  object db_VendasOrigem: TFDQuery
    ...
    object db_VendasOrigemICMS_BASECALCULO: TFloatField
      FieldName = 'ICMS_BASECALCULO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemICMS_VALOR: TFloatField
      FieldName = 'ICMS_VALOR'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemICMS_BASECALCULO_SUBSTITUICAO: TFloatField
      FieldName = 'ICMS_BASECALCULO_SUBSTITUICAO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemICMS_BASECALCULO_SUBSTITUICAO_VALOR: TFloatField
      FieldName = 'ICMS_BASECALCULO_SUBSTITUICAO_VALOR'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemICMS_REDUCAO: TFloatField
      FieldName = 'ICMS_REDUCAO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemICMS_REDUCAO_VALOR: TFloatField
      FieldName = 'ICMS_REDUCAO_VALOR'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemIPI_BASECALCULO: TFloatField
      FieldName = 'IPI_BASECALCULO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemIPI_VALOR: TFloatField
      FieldName = 'IPI_VALOR'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemISS: TFloatField
      FieldName = 'ISS'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemISS_BASECALCULO: TFloatField
      FieldName = 'ISS_BASECALCULO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemISS_VALOR: TFloatField
      FieldName = 'ISS_VALOR'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemVLR_FRETE: TFloatField
      FieldName = 'VLR_FRETE'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemVLR_SEGURO: TFloatField
      FieldName = 'VLR_SEGURO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemVLR_DESPESAS_ASSESSORIAS: TFloatField
      FieldName = 'VLR_DESPESAS_ASSESSORIAS'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemDESCONTO: TFloatField
      FieldName = 'DESCONTO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemVLR_DESCONTO: TFloatField
      FieldName = 'VLR_DESCONTO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemVLR_RECEBIDO: TFloatField
      FieldName = 'VLR_RECEBIDO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemTROCO: TFloatField
      FieldName = 'TROCO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemVLR_CAIXA: TFloatField
      FieldName = 'VLR_CAIXA'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    ...
    object db_VendasOrigemFRETE_PBRUTO: TFloatField
      FieldName = 'FRETE_PBRUTO'
    end
    object db_VendasOrigemFRETE_PLIQUIDO: TFloatField
    ...
    object db_VendasOrigemVALOR_PRODUTOS: TFloatField
      FieldName = 'VALOR_PRODUTOS'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_VendasOrigemTOTAL_NF: TFloatField
      FieldName = 'TOTAL_NF'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    ...
    object db_VendasOrigemVLR_CARTAO: TFloatField
      FieldName = 'VLR_CARTAO'
    end
    object db_VendasOrigemCONFERENCIA: TIntegerField
      FieldName = 'CONFERENCIA'
    end
    object db_VendasOrigemSIMPLESNACIONAL_ALIQUOTA: TFloatField
      FieldName = 'SIMPLESNACIONAL_ALIQUOTA'
    end
    object db_VendasOrigemSIMPLESNACIONAL_VALOR: TFloatField
  ...
  object frxImprimirDevolucao: TfrxReport
    ...
    ReportOptions.CreateDate = 42662.773180868050000000
    ReportOptions.LastChange = 42662.773180868050000000
