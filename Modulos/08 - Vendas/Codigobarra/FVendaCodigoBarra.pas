...
begin
   ...
   Begin
      ...
      begin
         ...
         If Achar[99] = '+' then
         begin
            FrmVendaExpressa.db_VendasItens.FieldByName('PRODUTO').AsString       := wTexto[99];
            FrmVendaExpressa.db_VendasItens.FieldByName('QUANTIDADE').AsInteger   := FrmVendaExpressa.db_VendasItens.FieldByName('QUANTIDADE').AsInteger + 1;

           FrmVendaExpressa.db_VendasItens.FieldByName('VLR_UNIT').AsFloat :=   ArrendondarDecimais(RetornaReferenciaPrecoVenda(wTexto[99]));

           FrmVendaExpressa.db_VendasItens.FieldByName('VLR_TOTAL').AsFloat :=  (FrmVendaExpressa.db_VendasItens.FieldByName('QUANTIDADE').AsFloat * FrmVendaExpressa.db_VendasItens.FieldByName('VLR_UNIT').AsFloat);
...
begin
   ...
   begin
      ...
      //if TestNumero(EditQtde.text) = false then
      if StrToTimeDef(EditQtde.text,0)=0 then
      begin
      ...
      begin
         ...
         FrmVendaExpressa.db_VendasItens.FieldByName('PRODUTO').AsString     :=  wTexto[99];
         FrmVendaExpressa.db_VendasItens.FieldByName('QUANTIDADE').AsFloat :=  FrmVendaExpressa.db_VendasItens.FieldByName('QUANTIDADE').AsInteger + StrToInt(EditQtde.text);
      ...
      begin
         ...
         FrmVendaExpressa.db_VendasItens.FieldByName('PRODUTO').AsString :=            wTexto[99];
         FrmVendaExpressa.db_VendasItens.FieldByName('QUANTIDADE').AsInteger :=        FrmVendaExpressa.db_VendasItens.FieldByName('QUANTIDADE').AsInteger - StrToInt(EditQtde.text);

         if FrmVendaExpressa.db_VendasItens.FieldByName('QUANTIDADE').AsInteger < 0 then
            FrmVendaExpressa.db_VendasItens.FieldByName('QUANTIDADE').AsInteger := 0;
