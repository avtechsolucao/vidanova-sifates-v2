object FrmRelPedidos: TFrmRelPedidos
  ...
  object chkEntregador: TCheckBox
    Left = 724
    Top = 131
    Width = 145
    Height = 17
  ...
  object EditTransportadora: TIDBEditDialog
    ...
    ButtonKeyClickBtn = 119
    SQLdbFazBusca = True
    SQLdbFocusControl = EditNomeTransportadora
    SQLdbCampoRetorno = 'NOME'
    SQLdbRetornoVazio = ' *** '
    SQLdbCampoParametro = 'CODIGO'
    SQLdbSQL.Strings = (
  ...
  object EditNomeTransportadora: TEdit
    Left = 815
    Top = 169
    Width = 224
    Height = 21
  ...
  object fsr_ComissaoPedidos: TfrxReport
    ...
    PreviewOptions.Buttons = [pbPrint, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbEdit, pbNavigator, pbExportQuick, pbNoClose, pbNoEmail]
  ...
  object fsr_PedidoGrade: TfrxReport
    ...
    ReportOptions.CreateDate = 39917.957612847210000000
    ReportOptions.Name = 'Listagem de Ordem de Produ'#231#227'o'
    ReportOptions.LastChange = 40941.842422395800000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      ''
  ...
  object fsr_RankingProdutos: TfrxReport
    ...
    ReportOptions.CreateDate = 39917.957612847210000000
    ReportOptions.Name = 'Listagem de Ordem de Produ'#231#227'o'
    ReportOptions.LastChange = 43740.000377361110000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      ''
      'procedure Page1OnBeforePrint(Sender: TfrxComponent);'
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo10: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[dbRankingProdutos."TIPO_PRODUTO"]')
          ParentFont = False
          WordWrap = False
        end
        object Memo1: TfrxMemoView
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object MemoTitulo: TfrxMemoView
          ...
          Fill.BackColor = 15724527
          Memo.UTF8W = (
            'Relat'#243'rio - PEDIDOS REALIZADOS:'
            'RANKING DE PRODUTOS')
          ParentFont = False
        end
        object Memo13: TfrxMemoView
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object SysMemo7: TfrxSysMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            'R$ [SUM(<dbRankingProdutos."VLR_TOTAL">,MasterData1)]')
          ParentFont = False
        end
      end
    end
  ...
  object fsr_RankingProdutosGrade: TfrxReport
    ...
    ReportOptions.CreateDate = 39917.957612847210000000
    ReportOptions.Name = 'Listagem de Ordem de Produ'#231#227'o'
    ReportOptions.LastChange = 40953.587006863400000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      ''
      'procedure Page1OnBeforePrint(Sender: TfrxComponent);'
