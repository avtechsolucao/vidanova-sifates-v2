...
begin
  ...
  mIDFPagto   := 0;
   ...
   vnCreditoSaldo :=0;
   vnCreditoSaldo :=ChecarCreditoSaldo(FrmVendaExpressa.db_vendas.FieldByName('CLIENTE').AsInteger);
  ...
  mIDCliente  := FrmVendaExpressa.db_vendas.FieldByName('VENDEDOR').AsInteger;
  mIDVendedor := FrmVendaExpressa.db_vendas.FieldByName('CLIENTE').AsInteger;
  mIDFPagto   := FrmVendaExpressa.db_vendas.FieldByName('FORMAPAGTO').AsInteger;
...
begin
   ...
   begin
      ...
      db_CtaReceber.FieldByName('FORMA_PAGTO').AsInteger :=          FrmVendaExpressa.db_vendas.FieldByName('FORMAPAGTO').AsInteger;
      db_CtaReceber.FieldByName('VENDEDOR').AsInteger :=             FrmVendaExpressa.db_vendas.FieldByName('VENDEDOR').AsInteger;
...
procedure TFrmGeraParcelasCupomNaoFiscal.FormShow(Sender: TObject);
begin
  EditCliente.Text   := mIDCliente.ToString;
  EditVendedor.Text  := mIDVendedor.ToString;
  EditPagamento.Text := mIDFPagto.ToString;

  If not (FrmVendaExpressa.db_vendas.state in [dsEdit, dsInsert]) then
