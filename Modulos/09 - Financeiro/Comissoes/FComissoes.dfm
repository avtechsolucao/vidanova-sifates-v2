object FrmComissoes: TFrmComissoes
  ...
  object db_Comissoes: TFDQuery
    ...
    object db_ComissoesCOMISSAO: TFloatField
      FieldName = 'COMISSAO'
      DisplayFormat = '###,##0.00%'
      EditFormat = '###,##0.00'
    end
    object db_ComissoesVALOR_VENDA: TFloatField
      FieldName = 'VALOR_VENDA'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_ComissoesVALOR: TFloatField
      FieldName = 'VALOR'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_ComissoesVALOR_PAGO: TFloatField
      FieldName = 'VALOR_PAGO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_ComissoesVALOR_SALDO: TFloatField
