object FrmChequesEmitidos: TFrmChequesEmitidos
  ...
  object db_pagar: TFDQuery
    ...
    object db_pagarVALOR: TFloatField
      FieldName = 'VALOR'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_pagarVALOR_PAGO: TFloatField
      FieldName = 'VALOR_PAGO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_pagarVALOR_SALDO: TFloatField
    ...
    object db_pagarDESCONTO: TFloatField
      FieldName = 'DESCONTO'
    end
    ...
    object db_pagarDESPESAS_BOLETO: TFloatField
      FieldName = 'DESPESAS_BOLETO'
    end
    object db_pagarDESPESAS_JUROS: TFloatField
      FieldName = 'DESPESAS_JUROS'
    end
    object db_pagarDESPESAS_MULTA: TFloatField
      FieldName = 'DESPESAS_MULTA'
    end
    object db_pagarDESPESAS_CARTORIO: TFloatField
      FieldName = 'DESPESAS_CARTORIO'
    end
    object db_pagarDESPESAS_TOTAL: TFloatField
