object FrmBoletoBancario: TFrmBoletoBancario
  ...
  object GroupBox2: TGroupBox
    ...
    object btnPesquisarBoletos: TButton
      Left = 2
      Top = 15
      Width = 982
      Height = 34
      ...
      ParentFont = False
      TabOrder = 0
      OnClick = btnPesquisarBoletosClick
    end
  end
  ...
  object db_ViewBoletos: TFDQuery
    ...
    object db_ViewBoletosVALOR: TFloatField
      FieldName = 'VALOR'
      DisplayFormat = '###,##0.00'
    end
  ...
  object db_ViewBoletosRemessas: TFDQuery
    ...
    object db_ViewBoletosRemessasVALOR: TFloatField
      FieldName = 'VALOR'
    end
