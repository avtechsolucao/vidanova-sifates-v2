...
type
   TFrmBordero = class(TForm)
    ...
    db_BorderoListaVALOR: TFloatField;
    db_BorderoListaVALORLIQUIDO: TFloatField;
    Label5: TLabel;
    DBEdit3: TDBEdit;
    DBEdit5: TDBEdit;
    Label6: TLabel;
    ...
    db_BorderoTITULOSVALOR: TFloatField;
    db_BorderoJUROS: TFloatField;
    db_BorderoTARIFA: TFloatField;
    ...
    db_somar: TFDQuery;
    db_BorderoTITULOSVALORBRUTO: TFloatField;
    db_BorderoVALORJUROS: TFloatField;
    db_BorderoVALORTARIFAS: TFloatField;
    db_BorderoListaVALORJUROS: TFloatField;
    db_BorderoListaVALORTARIFAS: TFloatField;
    DBEdit4: TDBEdit;
    Label9: TLabel;
...
begin
   ...
   begin
      ...
      begin
         ...
         db_BorderoLista.FieldByName('CLIENTE_NOME').AsString                  :=GetClienteCampo(dbDlgProcurar.ResultFieldAsInteger('CLIENTE'),'NOME') ;
...
begin
   db_BorderoLista.FieldByName('CLIENTE_NOME').AsString                  :=GetClienteCampo(db_BorderoLista.FieldByName('CLIENTE').AsInteger,'NOME') ;
end;
