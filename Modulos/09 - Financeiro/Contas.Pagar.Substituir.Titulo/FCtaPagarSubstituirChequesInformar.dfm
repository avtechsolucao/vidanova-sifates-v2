object FrmCtaPagarSubstituirChequesInformar: TFrmCtaPagarSubstituirChequesInformar
  ...
  object db_CtaPagarCheque: TFDQuery
    ...
    object db_CtaPagarChequeVALOR: TFloatField
      FieldName = 'VALOR'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_CtaPagarChequeVALOR_PAGO: TFloatField
      FieldName = 'VALOR_PAGO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_CtaPagarChequeVALOR_SALDO: TFloatField
    ...
    object db_CtaPagarChequeDESCONTO: TFloatField
      FieldName = 'DESCONTO'
    end
    object db_CtaPagarChequeDESCONTOVALOR: TFloatField
    ...
    object db_CtaPagarChequeDESPESAS_BOLETO: TFloatField
      FieldName = 'DESPESAS_BOLETO'
    end
    object db_CtaPagarChequeDESPESAS_JUROS: TFloatField
      FieldName = 'DESPESAS_JUROS'
    end
    object db_CtaPagarChequeDESPESAS_JUROSVALOR: TFloatField
      FieldName = 'DESPESAS_JUROSVALOR'
    end
    object db_CtaPagarChequeDESPESAS_MULTA: TFloatField
      FieldName = 'DESPESAS_MULTA'
    end
    object db_CtaPagarChequeDESPESAS_CARTORIO: TFloatField
      FieldName = 'DESPESAS_CARTORIO'
    end
    object db_CtaPagarChequeDESPESAS_TOTAL: TFloatField
