...
uses
  ...
  FireDAC.Comp.Client, Data.DB, FireDAC.Comp.DataSet, Vcl.ComCtrls,
  Vcl.StdCtrls, Vcl.DBCtrls, cxTextEdit, cxCurrencyEdit, ISFEdit, ISFEditbtn,
  ISFdbEditbtn, IDBEdit, uEstSearchDialogZeos, Vcl.Mask, Vcl.Buttons,
  FFrameBarra, Vcl.ExtCtrls,
  Classe.Global;
...
type
  TFrmFaseProducaoRetornoTerceirizados = class(TForm)
    ...
    EditTotalPagar: TcxCurrencyEdit;
    Label3: TLabel;
    editCustoUnitario: TcxCurrencyEdit;
    Label4: TLabel;
