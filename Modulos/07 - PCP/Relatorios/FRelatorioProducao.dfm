object FrmRelatorioProducao: TFrmRelatorioProducao
    ...
    object Panel1: TPanel
      ...
      object GroupBox7: TGroupBox
        ...
        object RadioTipo_Relatorio: TRadioGroup
          ...
          ItemIndex = 0
          Items.Strings = (
            '0 - Listagem de Ordem de Produ'#231#227'o'
            '1 - Necessidade de Produ'#231#227'o'
            '2 - Fichas T'#233'cnicas Cadastradas'
            '3 - Pe'#231'as Produzidas'
            '4 - Estoque Dispon'#237'vel'
            '5 - Localiza'#231#227'o de Fase'
            '6 - Hist'#243'rico de Fase')
          ParentFont = False
          TabOrder = 0
  ...
  object dbFichasTecnicas: TFDQuery
    ...
    SQL.Strings = (
      ...
      'TIPO_PRODUTO='#39'ACA'#39
      'and'
      'data  between '#39'01/01/2011'#39' and '#39'12/31/2016'#39
  ...
  object frxEstoqueDisponivel: TfrxReport
    ...
    ReportOptions.LastChange = 43121.932827187500000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
