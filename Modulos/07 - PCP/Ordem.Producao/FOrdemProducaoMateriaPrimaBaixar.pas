...
type
   TFrmOrdemProducaoMateriaPrimaBaixar = class(TForm)
    ...
    db_MateriaPrimaOrigemQTDE: TFloatField;
    db_MateriaPrimaOrigemQTDE_CONSUMOSTOTAL: TFloatField;
    db_MateriaPrimaOrigemVLR_UNIT: TFloatField;
    db_MateriaPrimaOrigemVLR_CUSTOTOTAL: TFloatField;
    db_MateriaPrimaOrigemESTOQUE: TFloatField;
    db_MateriaPrimaOrigemNECESSIDADE: TFloatField;
...
begin
   ...
   FUsuario.LogUsuario('ordem de produção | Matéria Prima','Baixou Matéria Prima (diminiu do estoque) referente Ordem de Produção: ' + IntToStr(nOrdemProducao)  );
...
begin
   ...
   FUsuario.LogUsuario('ordem de produção | Matéria Prima','Estornou Matéria Prima (devolveu ao estoque) referente Ordem de Produção: ' + IntToStr(nOrdemProducao)  );
...
begin
   ...
   FUsuario.LogUsuario('ordem de produção | Matéria Prima','saiu do módulo Baixa de Matéria Prima. Referente Ordem de Produção: ' + IntToStr(nOrdemProducao)  );
   db_MateriaPrima.close;
   Action := Cafree;
...
begin
   ...
   FUsuario.LogUsuario('ordem de produção | Matéria Prima','Entrou no módulo Baixa de Matéria Prima. Referente Ordem de Produção: ' + IntToStr(nOrdemProducao)  );
         ...
         //begin
          ...
          //begin
             ...
             begin
                ...
                db_MateriaPrimaGrade.FieldByName('ID').AsInteger              := db_MateriaPrima.FieldByName('ID').AsInteger ;
         ...
         begin
          ...
          //begin
             ...
             begin
                ...
                db_MateriaPrimaTecidosGrade.FieldByName('ID').AsInteger                   := db_MateriaPrimaTecidos.FieldByName('ID').AsInteger;
