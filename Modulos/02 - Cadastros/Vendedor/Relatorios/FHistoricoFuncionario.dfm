object FrmHistoricoFuncionario: TFrmHistoricoFuncionario
  ...
  object db_CaixaFuncionarios: TFDQuery
    ...
    object db_CaixaFuncionariosDATA: TSQLTimeStampField
      FieldName = 'DATA'
      EditMask = '99/99/9999'
    end
    object db_CaixaFuncionariosVENCIMENTO: TSQLTimeStampField
      FieldName = 'VENCIMENTO'
      EditMask = '99/99/9999'
    end
    ...
    object db_CaixaFuncionariosVALOR: TFloatField
      FieldName = 'VALOR'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
